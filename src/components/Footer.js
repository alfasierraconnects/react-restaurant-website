  ...
  return (
    <div>
      ...
      <footer id="footer" className="bg-gray-800 py-16 mt-24">
        <div className="container px-28 p-6 mx-auto flex justify-between">
          <div className="w-3/5 -mx-6 px-6">
            ...
            <p className="max-w-sm my-6 text-gray-500 dark:text-gray-200">
              Nestled in the heart of the city, Tomato has been serving
              delectable dishes and creating memorable dining experiences for
              food enthusiasts since 1968.
            </p>
